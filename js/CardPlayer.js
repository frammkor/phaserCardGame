...
export default class CardPlayer extends CardDraggable {
  constructor(data) {
    ...
    /* we already add the card to the scene so we will add this elements to the component */
  ...
  set armor(newArmor) {
    ...
    // prevents it from overflowing the icon
    this.textArmor.x = 47 - this.textArmor.width / 2;
    // if its 0 we dont want to show it;
